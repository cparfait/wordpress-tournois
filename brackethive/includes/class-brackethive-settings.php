 ...
 * inscriptions…) vit dans Brackethive_Tournament. Cette classe ne conserve que les
...
class Brackethive_Settings {

	const OPTION = 'brackethive_settings';
	...
	public static function save( $input ) {
		...
		if ( isset( $input['plugin_locale'] ) ) {
			...
			$known                = array_keys( brackethive_available_locales() );
			$known[]              = 'en_US';
